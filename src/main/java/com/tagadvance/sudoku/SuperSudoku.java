...
class SuperSudoku extends AbstractSudoku {
	...
	public SuperSudoku(AbstractSudoku parent) {
		super(parent);
	}
	...
	public static AbstractSudoku demo() {
		AbstractSudoku sudoku = new SuperSudoku();
	...
	public static AbstractSudoku demo2() {
		return AbstractSudoku.demo(new SuperSudoku(),
